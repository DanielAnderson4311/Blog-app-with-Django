...
urlpatterns = [
    ...
    path('posts/<int:post_id>/', views.viewpost),
    ...
    path('posts/myposts/delete/<int:post_id>/', views.deletepost), # this will be for the page to edit a post. I WILL need to check that the user has the permission to edi this post by comparing the user and the publisher    
    path('search/', views.search), # This will be for the search page      
]
